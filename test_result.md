...
agent_communication:
  ...
  - agent: "testing"
    message: |
      ...
      🌐 **BACKEND URL CONFIRMED**: https://inventory-reconcile.preview.emergentagent.com
  ...
  - agent: "testing"
    message: |
      ...
      - Backend URL: https://inventory-reconcile.preview.emergentagent.com/api
  ...
  - agent: "testing"
    message: |
      ...
      🌐 BACKEND URL VERIFIED: https://inventory-reconcile.preview.emergentagent.com/api
  ...
  - agent: "testing"
    message: |
      ...
      🌐 BACKEND URL CONFIRMED: https://inventory-reconcile.preview.emergentagent.com/api
  ...
  - agent: "testing"
    message: |
      ...
      🌐 BACKEND URL STABLE: https://inventory-reconcile.preview.emergentagent.com/api
