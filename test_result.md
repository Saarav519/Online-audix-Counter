...
agent_communication:
  ...
  - agent: "testing"
    message: |
      ...
      🌐 **BACKEND URL CONFIRMED**: https://master-stock-config.preview.emergentagent.com
  ...
  - agent: "testing"
    message: |
      ...
      - Backend URL: https://master-stock-config.preview.emergentagent.com/api
  ...
  - agent: "testing"
    message: |
      ...
      🌐 BACKEND URL VERIFIED: https://master-stock-config.preview.emergentagent.com/api
  ...
  - agent: "testing"
    message: |
      ...
      🌐 BACKEND URL CONFIRMED: https://master-stock-config.preview.emergentagent.com/api
  ...
  - agent: "testing"
    message: |
      ...
      🌐 BACKEND URL STABLE: https://master-stock-config.preview.emergentagent.com/api
