      ...
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {filteredData && (
              <Button onClick={exportReport} variant="outline" data-testid="export-excel-btn">
                <Download className="w-4 h-4 mr-2" />
                Export Excel
              </Button>
            )}
            {filteredData && (
              <Button onClick={exportPDF} variant="outline" className="text-rose-600 border-rose-200 hover:bg-rose-50" data-testid="export-pdf-btn">
