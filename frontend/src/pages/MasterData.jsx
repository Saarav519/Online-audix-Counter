...
const MasterData = () => {
  const { masterProducts, addMasterProduct, importMasterProducts } = useApp();
    ...
    reader.onload = (e) => {
      try {
        ...
        const products = dataLines.map(line => {
          const [barcode, name, sku, category, price] = line.split(',').map(s => s.trim());
          return {
            barcode,
            name,
            sku: sku || '',
        ...
        const count = importMasterProducts(products);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage your product database</p>
        </div>
      ...
      <Dialog open={showImportModal} onOpenChange={(open) => {
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="py-4 space-y-4">
            ...
            <div className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-slate-200 rounded-lg hover:border-emerald-400 transition-colors">
